...
export const DoodleStar = ({ className }: { className?: string }) => (
   <svg viewBox="0 0 50 50" fill="currentColor" className={className}>
     <path d="M25 0 L31 19 L50 25 L31 31 L25 50 L19 31 L0 25 L19 19 Z" />
   </svg>
);
...
export const DoodleSpiral = ({ className }: { className?: string }) => (
   <svg viewBox="0 0 100 100" fill="none" stroke="currentColor" strokeWidth="5" className={className}>
     <path d="M50 50 m0 0 a1 1 0 0 1 20 0 a2 1 0 0 1 -40 0 a3 1 0 0 1 60 0 a4 1 0 0 1 -80 0" strokeLinecap="round" />
   </svg>
);